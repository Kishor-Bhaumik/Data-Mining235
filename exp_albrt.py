...
@dataclass
class Config:
    experiment_name: str = "exp_11albert_exp7"
    seed: int = 12
    model_name: str ="albert/albert-base-v1" # "bert-base-uncased"
    use_wandb: bool = False
    wandb_project: str = "raid-text-detection-exp7"

    batch_size: int = 12 #8 #8
    num_epochs: int = 1
    ...
    target_modules: list = field(default_factory=lambda:['query', 'key', 'value'])  # distilbert specific: ['q_lin', 'v_lin']
